            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(id) {
                    case R.id.item1:
                        ...
                        Intent InteNt =new Intent(getApplicationContext(),MainActivityPesan .class);
                        startActivity(InteNt);
                        break;
                    case R.id.item2:
                        Toast.makeText(MainActivity.this,
                                "informasi di klik", Toast.LENGTH_SHORT).show();
                    ...
                    case R.id.item4:
                        Toast.makeText(MainActivity.this,
                                "whatsaap di klik", Toast.LENGTH_SHORT).show();
